/** Nocturnal Flow — the dark palette, and the token contract every theme fills.
 * The light counterpart lives in `themes.ts`; components must reference these
 * token names via `useThemeColors()`/`useStyles()` (never raw hex or this object
 * directly) so themes swap at runtime. */
export const colors = {
  surface: '#121414',
  surfaceDim: '#121414',
  ...
  // Translucent / scrim tokens (alpha baked into the 8-digit hex).
  buttonGlow: '#ffffff0d',
  backdrop: '#00000080',
  headerScrim: '#121414d9',
  navBar: '#38393a99',
  navActive: '#ffc69a29',
} as const;
